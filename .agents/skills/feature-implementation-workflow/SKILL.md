...
```mermaid
flowchart TD
    A["1. Requirements Analysis (USER_STORIES.md)"] --> B["2. Invariants & Architecture Check (AGENT.md)"]
    ...
    F --> G["7. Update Tracking (AGENT.md & agents.md)"]
...
* Identify the target user story and acceptance criteria in [USER_STORIES.md](../../../USER_STORIES.md) (e.g., `US 3.4: Erfassung von Gewicht, Wiederholungen und Kadenz`, `AK 3.4.1`–`AK 3.4.4`).
* Define the exact boundary of what will be implemented in this iteration.

### Step 2: Invariants & Architecture Check
Before writing any code, verify that the design complies with the non-negotiables in [AGENT.md](../../../AGENT.md):
...
* Open [AGENT.md](../../../AGENT.md) and [agents.md](../../../agents.md).
